...
#include "/usr/local/Ascend/ascend-toolkit/8.0.RC2.2/aarch64-linux/include/acl/acl_op_compiler.h"
#include "/usr/local/Ascend/ascend-toolkit/latest/python/site-packages/bin/Disp/build_out/autogen/aclnn_de_disp.h"
#include "common.h"
